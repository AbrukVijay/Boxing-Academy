    ...
    <><UserHome /><div>
      ...
      <div style={{ flex: '1', overflowY: 'auto' }}>
        ...
        <div style={{ paddingBottom: '0px' }}>
          <center><a href='/page2'><button className='btn btn-warning' style={{ fontSize: '25px', paddind: '50px', width: '300px', height: '50px', borderRadius: '10px' }}>Rate Us</button></a></center>
        </div>
